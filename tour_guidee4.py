...
class TourGuideDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        input_tokens = self.tokenizer(input_text, return_tensors='pt', padding='max_length', truncation=True, max_length=512)
        response_tokens = self.tokenizer(response_text, return_tensors='pt', padding='max_length', truncation=True, max_length=512)
